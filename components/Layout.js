...
const navigation = [
  ...
  { name: 'Mykit', href: '#', icon: ClockIcon, current: false },
  { name: 'Popular', href: '#', icon: ScaleIcon, current: false },
  { name: 'Mostviews', href: '#', icon: CreditCardIcon, current: false },
  { name: 'Playground', href: '#', icon: UserGroupIcon, current: false },
]
